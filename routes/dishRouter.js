...
.get((req,res,next) => {
    ...
    .then((dish)=>{
        if(dish!= null && dish.comments.id(req.params.commentId) != null){
            ...
            err = new Error('Comment' + req.params.commentId + ' doesn\'t exist')
            err.statusCode= 404
            return next(err)
        }
...
.put(authenticate.verifyUser, (req, res, next) => {
    ...
    .then((dish)=>{
        ...
        && dish.comments.id(req.params.commentId).author._id.equals(req.user._id) ){
            ...
            err = new Error('You can not edit comment of others')
            err.statusCode= 403
            return next(err)
        }
    },(err)=>next(err))
...
.delete(authenticate.verifyUser,(req, res, next) => {
    Dishes.findById(req.params.dishId)
        .then((dish)=>{
            ...
            err = new Error('You can not delete comment of others')
            err.statusCode= 403
            return next(err)
        }
